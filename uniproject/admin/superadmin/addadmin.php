        ...
        <div class="row">
          ...
          <form class="form" role="form" autocomplete="" name="form1" method="post" action="include/signupadmin.php" onSubmit="return check();">
                            ...
                            <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input class="form-control"  name="admin_email" type="email" value="" required>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-sm-3 col-form-label form-control-label">Password </label>
                                    <div class="col-sm-9">
                                        <input class="form-control" name="admin_password" type="password" value="" required >
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-sm-3 col-form-label form-control-label">Full Name </label>
                                    <div class="col-sm-9">
                                        <input class="form-control" name="admin_name" type="text" value="" required>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input class="form-control" name="admin_phone" type="text" value="" required>
                                    </div>
                                </div>
